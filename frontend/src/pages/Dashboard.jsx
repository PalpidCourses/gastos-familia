    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex gap-8">
        ...
        <aside className="w-full lg:w-1/4 flex flex-col gap-6">
          <div className="bg-white dark:bg-white/5 rounded-xl p-6 border border-primary/10 shadow-sm">
        ...
        <main className="w-full lg:w-3/4 flex flex-col gap-8">
          <div className="bg-white dark:bg-white/5 rounded-xl p-8 border border-primary/10 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Bienvenido, David 👋</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Sprint 1 en progreso. El backend y frontend básico ya están configurados.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-primary/5 rounded-lg border border-primary/10">
                <h3 className="text-lg font-semibold text-primary mb-2">Base de Datos</h3>
                <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  <li>✓ Schema con RLS</li>
                  <li>✓ Multitenancy</li>
